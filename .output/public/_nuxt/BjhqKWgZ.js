import{_ as $,a as v}from"./CCnzxV4O.js";import{Q as y,b2 as d,aQ as B,b5 as x,b9 as A,bk as C,G as H,bb as w,at as S,y as T,bl as F,O as L,aO as e,x as r,aH as M,v as n}from"./D-lbm_bm.js";import{u as N}from"./BBemdt2j.js";import{A as k}from"./xsKDbFZ9.js";const D={class:"prose lg:prose-lg max-w-none"},E=["innerHTML"],Q=y({__name:"[article]",async setup(P){let t,c;const{t:s}=d(),{shopify:{shopName:h}}=B(),i=x(),{locale:b}=d(),o=A(),l=n(()=>o.params.handle),u=n(()=>o.params.article),{data:m,error:p}=([t,c]=C(()=>N(`article-${b.value}-${l.value}`,`#graphql
