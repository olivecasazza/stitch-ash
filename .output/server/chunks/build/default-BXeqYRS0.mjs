...
const __nuxt_component_5 = Object.assign(_sfc_main$6, { __name: "ProductPrice" });
const _sfc_main$5 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_ProductPrice = __nuxt_component_5;
...
const __nuxt_component_4 = Object.assign(_sfc_main$5, { __name: "CartLineItem" });
const _sfc_main$4 = /* @__PURE__ */ vueExports.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_CartLineItem = __nuxt_component_4;
      const _component_ProductPrice = __nuxt_component_5;
            ...
            return [
              vueExports.createVNode("div", { class: "relative" }, [
                ...
                vueExports.createVNode(_component_ClientOnly, null, {
                  default: vueExports.withCtx(() => [
                    vueExports.unref(quantity) ? (vueExports.openBlock(), vueExports.createBlock(_component_UBadge, {
                      key: 0,
...
//# sourceMappingURL=default-BXeqYRS0.mjs.map
