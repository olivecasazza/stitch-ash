...
const PRODUCTS = [
  {
    ...
    price: 185,
    description: "Baggy, oversized, and completely black. The design sits on the chest panel; the brand mark anchors the left sleeve. Two embroidered elements, one piece. Built for the long haul.",
    embroideryCopy: "Black thread on black cotton. Design embroidered on chest panel; small brand mark on left sleeve.",
    sizes: [
      { label: "S", value: "S" },
      { label: "M", value: "M" },
      { label: "L", value: "L" },
  ...
  },
  {
    ...
    price: 35,
    description: "Heavy woven black fabric. The brand mark runs the full length — repeated, tight, only visible when the light catches. One size. Breakaway clip.",
    embroideryCopy: "Black thread on black weave. Repeated brand-mark pattern along length.",
  ...
  },
  {
    ...
    price: 15,
    description: "Not a print. Fully stitched, black thread on black backing. A single composition — design and brand mark merged. Adhesive backing for flat surfaces or heat press for fabric.",
    embroideryCopy: "Black thread on black backing. Single design with embedded brand mark.",
    sizes: [{ label: "One size", value: "one-size" }],
    badge: "made-to-order",
...
//# sourceMappingURL=products-BY7H9gon.mjs.map
