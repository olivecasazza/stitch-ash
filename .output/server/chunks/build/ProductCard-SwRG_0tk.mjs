...
import { _ as __nuxt_component_0$2 } from './Badge-B9wa0G88.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer_cjs_prodExports.ssrRenderComponent(_component_NuxtLink, vueExports.mergeProps({
        ...
        default: vueExports.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="product-card__image-wrap" data-v-576c0527${_scopeId}>`);
            if (__props.imageSrc) {
              _push2(`<!--[--><img class="${serverRenderer_cjs_prodExports.ssrRenderClass(["product-card__img", "product-card__img--primary", { "has-hover": __props.hoverImageSrc }])}"${serverRenderer_cjs_prodExports.ssrRenderAttr("src", __props.imageSrc)}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", vueExports.unref(finalImageAlt))} loading="lazy" decoding="async" data-v-576c0527${_scopeId}>`);
              if (__props.hoverImageSrc) {
                _push2(`<img class="product-card__img product-card__img--hover"${serverRenderer_cjs_prodExports.ssrRenderAttr("src", __props.hoverImageSrc)}${serverRenderer_cjs_prodExports.ssrRenderAttr("alt", `${vueExports.unref(finalImageAlt)} — detail`)} loading="lazy" decoding="async" aria-hidden="true" data-v-576c0527${_scopeId}>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`<!--]-->`);
            } else {
              _push2(`<div class="product-card__placeholder" aria-hidden="true" data-v-576c0527${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.name.toLowerCase())}</div>`);
            }
            _push2(`</div><div class="product-card__body" data-v-576c0527${_scopeId}><div class="product-card__row" data-v-576c0527${_scopeId}><h3 class="product-card__name" data-v-576c0527${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.name)}</h3>`);
            if (__props.badge) {
            ...
            _push2(`</div>`);
            if (__props.note) {
              _push2(`<p class="product-card__note" data-v-576c0527${_scopeId}>${serverRenderer_cjs_prodExports.ssrInterpolate(__props.note)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<p class="product-card__price" data-v-576c0527${_scopeId}>$${serverRenderer_cjs_prodExports.ssrInterpolate(__props.price)}</p></div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-576c0527"]]), { __name: "ProductCard" });

export { __nuxt_component_0 as _ };
//# sourceMappingURL=ProductCard-SwRG_0tk.mjs.map
