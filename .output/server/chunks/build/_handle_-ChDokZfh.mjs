import { _ as __nuxt_component_0 } from './Badge-CQj1DBYI.mjs';
import { ax as vueExports, aq as useRoute$1, s as createError, a9 as useCart, as as useSeoMeta, a2 as serverRenderer_cjs_prodExports } from './server.mjs';
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-69936699"]]), { __name: "SizeSelector" });
...
`, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${serverRenderer_cjs_prodExports.ssrRenderAttrs(vueExports.mergeProps({ class: "pdp wrap" }, _attrs))} data-v-df9f9b2a>`);
      if (vueExports.unref(isPreview)) {
        _push(`<div class="pdp__preview-notice" role="status" data-v-df9f9b2a><span data-v-df9f9b2a>Preview — commerce not yet wired. No checkout available.</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="pdp__layout" data-v-df9f9b2a><div class="pdp__gallery" data-v-df9f9b2a><div class="pdp__image-placeholder"${serverRenderer_cjs_prodExports.ssrRenderAttr("data-zoomed", vueExports.unref(zoomed) ? "" : void 0)} role="button"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", vueExports.unref(zoomed) ? "Collapse image" : "Zoom image")} tabindex="0" data-v-df9f9b2a><svg viewBox="0 0 600 750" xmlns="http://www.w3.org/2000/svg"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", `${vueExports.unref(displayName)} — product image coming soon`)} role="img" class="pdp__placeholder-svg" style="${serverRenderer_cjs_prodExports.ssrRenderStyle(vueExports.unref(zoomed) ? { transform: "scale(1.6)" } : {})}" data-v-df9f9b2a><rect width="600" height="750" fill="#0B0B0B" data-v-df9f9b2a></rect><rect x="1" y="1" width="598" height="748" fill="none" stroke="#C0C0C0" stroke-width="1" stroke-dasharray="6 6" opacity="0.4" data-v-df9f9b2a></rect><g stroke="#1A1A1A" stroke-width="1" opacity="0.6" data-v-df9f9b2a><!--[-->`);
      serverRenderer_cjs_prodExports.ssrRenderList(20, (i) => {
        _push(`<line${serverRenderer_cjs_prodExports.ssrRenderAttr("x1", 0)}${serverRenderer_cjs_prodExports.ssrRenderAttr("y1", (i - 1) * 40)}${serverRenderer_cjs_prodExports.ssrRenderAttr("x2", 600)}${serverRenderer_cjs_prodExports.ssrRenderAttr("y2", (i - 1) * 40)} data-v-df9f9b2a></line>`);
      });
      _push(`<!--]--><!--[-->`);
      serverRenderer_cjs_prodExports.ssrRenderList(15, (i) => {
        _push(`<line${serverRenderer_cjs_prodExports.ssrRenderAttr("x1", (i - 1) * 42)}${serverRenderer_cjs_prodExports.ssrRenderAttr("y1", 0)}${serverRenderer_cjs_prodExports.ssrRenderAttr("x2", (i - 1) * 42)}${serverRenderer_cjs_prodExports.ssrRenderAttr("y2", 750)} data-v-df9f9b2a></line>`);
      });
      _push(`<!--]--></g><text x="300" y="360" text-anchor="middle" dominant-baseline="middle" fill="#C0C0C0" font-family="Inter, system-ui, sans-serif" font-size="13" letter-spacing="0.12em" opacity="0.5" data-v-df9f9b2a>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(displayName).toUpperCase())}</text><text x="300" y="385" text-anchor="middle" dominant-baseline="middle" fill="#C0C0C0" font-family="Inter, system-ui, sans-serif" font-size="10" letter-spacing="0.1em" opacity="0.35" data-v-df9f9b2a> PHOTOGRAPHY COMING SOON </text></svg><button class="pdp__zoom-btn"${serverRenderer_cjs_prodExports.ssrRenderAttr("aria-label", vueExports.unref(zoomed) ? "Collapse image" : "Zoom image")} data-v-df9f9b2a><svg viewBox="0 0 20 20" width="16" height="16" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true" data-v-df9f9b2a><circle cx="8" cy="8" r="5.5" data-v-df9f9b2a></circle><line x1="12.5" y1="12.5" x2="18" y2="18" data-v-df9f9b2a></line>`);
      if (!vueExports.unref(zoomed)) {
        _push(`<line x1="8" y1="5.5" x2="8" y2="10.5" data-v-df9f9b2a></line>`);
      } else {
        _push(`<!---->`);
      }
      if (!vueExports.unref(zoomed)) {
        _push(`<line x1="5.5" y1="8" x2="10.5" y2="8" data-v-df9f9b2a></line>`);
      } else {
        _push(`<!---->`);
      }
      if (vueExports.unref(zoomed)) {
      ...
      _push(`</svg></button></div></div><div class="pdp__info" data-v-df9f9b2a><div class="pdp__badges" data-v-df9f9b2a>`);
      ...
      _push(`</div><h1 class="pdp__name" data-v-df9f9b2a>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(displayName))}</h1><p class="pdp__price" data-v-df9f9b2a>$${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(displayPrice))}</p><p class="pdp__description" data-v-df9f9b2a>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(displayDescription))}</p><p class="pdp__embroidery-note" data-v-df9f9b2a>${serverRenderer_cjs_prodExports.ssrInterpolate(vueExports.unref(staticProduct)?.embroideryCopy)}</p><div class="pdp__size-wrap" data-v-df9f9b2a>`);
      if (vueExports.unref(hasRealSizes)) {
        ...
        _push(`<p class="pdp__one-size" data-v-df9f9b2a><span class="pdp__one-size-label" data-v-df9f9b2a>Size</span> One size </p>`);
      }
      _push(`</div>`);
      if (vueExports.unref(variantId)) {
        _push(`<button class="pdp__atc-btn pdp__atc-btn--primary" data-v-df9f9b2a> Add to cart </button>`);
      } else {
        _push(`<button class="pdp__atc-btn pdp__atc-btn--disabled" disabled aria-disabled="true" data-v-df9f9b2a> Made to order — coming soon </button>`);
      }
      _push(`<div class="pdp__accordion-wrap" data-v-df9f9b2a>`);
...
const _handle_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-df9f9b2a"]]);

export { _handle_ as default };
//# sourceMappingURL=_handle_-ChDokZfh.mjs.map
