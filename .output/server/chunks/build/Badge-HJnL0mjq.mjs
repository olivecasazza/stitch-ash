import { ax as vueExports, ac as useComponentProps, a7 as useAppConfig, ag as useFieldGroup, ab as useComponentIcons, a5 as tv, a2 as serverRenderer_cjs_prodExports, e as Primitive, l as _sfc_main$f, i as _sfc_main$c } from './server.mjs';
            ...
            return [
              vueExports.renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                vueExports.unref(isLeading) && vueExports.unref(leadingIconName) ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$f, {
                  ...
                  "data-slot": "leadingIcon",
                  class: ui.value.leadingIcon({ class: vueExports.unref(props).ui?.leadingIcon })
                }, null, 8, ["name", "class"])) : !!vueExports.unref(props).avatar ? (vueExports.openBlock(), vueExports.createBlock(_sfc_main$c, vueExports.mergeProps({
                  key: 1,
                  size: vueExports.unref(props).ui?.leadingAvatarSize || ui.value.leadingAvatarSize()
                }, vueExports.unref(props).avatar, {
                  "data-slot": "leadingAvatar",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.0_@internationalized+date@3.12.1_@internationalized+number@3.6.6_@tiptap+e_d719e0a183cea98ed15f9fdb5506ba26/node_modules/@nuxt/ui/dist/runtime/components/Badge.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as _ };
//# sourceMappingURL=Badge-HJnL0mjq.mjs.map
