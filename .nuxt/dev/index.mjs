import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { createDatabase } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/db0@0.3.4/node_modules/db0/dist/index.mjs';
import { tmpdir } from 'node:os';
import { isEvent, defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, createError, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, getCookie, setCookie, sanitizeStatusCode, removeResponseHeader, readValidatedBody, getQuery as getQuery$1, getRouterParam, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getHeader, getResponseStatusText } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import crypto$1 from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@vue+shared@3.5.34/node_modules/@vue/shared/dist/shared.cjs.js';
import viteNodeEntry_mjs from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@nuxt+vite-builder@4.4.6_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@types+nod_71a2d2a57d2f7fd184e6def600c86b64/node_modules/@nuxt/vite-builder/dist/vite-node-entry.mjs';
import { viteNodeFetch } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@nuxt+vite-builder@4.4.6_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@types+nod_71a2d2a57d2f7fd184e6def600c86b64/node_modules/@nuxt/vite-builder/dist/vite-node.mjs';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/vue-bundle-renderer@2.2.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, joinRelativeURL, parsePath, withLeadingSlash, withoutTrailingSlash, withTrailingSlash, decodePath, encodePath } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/ufo@1.6.4/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/drivers/fs.mjs';
import lruCache from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/drivers/lru-cache.mjs';
import fsDriver from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unstorage@1.17.5_db0@0.3.4_ioredis@5.10.1/node_modules/unstorage/drivers/fs-lite.mjs';
import { digest, hash as hash$1 } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { createConsola, consola as consola$1 } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/youch@4.1.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { createRouterMatcher } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/vue-router@5.0.7_@vue+compiler-sfc@3.5.34_vue@3.5.34_typescript@6.0.3_/node_modules/vue-router/vue-router.node.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/devalue@5.8.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/vue@3.5.34_typescript@6.0.3/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@nuxt+vite-builder@4.4.6_@babel+plugin-syntax-jsx@7.28.6_@babel+core@7.29.0__@types+nod_71a2d2a57d2f7fd184e6def600c86b64/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { z } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/zod@4.4.3/node_modules/zod/index.js';
import { createGraphQLClient } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@shopify+graphql-client@1.4.2/node_modules/@shopify/graphql-client/dist/index.mjs';
import { getUserSession } from 'file:///home/olive/Repositories/stitch-ash/.nuxt/shopify/auth-utils.mjs';
import { getIcons } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/@iconify+utils@3.1.3/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///home/olive/Repositories/stitch-ash/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unhead@2.1.15/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/vue@3.5.34_typescript@6.0.3/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/olive/Repositories/stitch-ash/node_modules/.pnpm/unhead@2.1.15/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/olive/Repositories/stitch-ash/server/assets"}];
...
const _47home_47olive_47Repositories_47stitch_45ash_47node_modules_47_46pnpm_47_64nuxt_43nitro_45server_644_464_466__64babel_43plugin_45syntax_45typescript_647_4628_466__64babel_43core_647_4629_460__db0_98812eafb88dd10d4ca957f6d9b93d29_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage$1.mount('storefront-proxy', lruCache({"driver":"lru-cache"}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/olive/Repositories/stitch-ash","watchOptions":{"ignored":[null]}}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/olive/Repositories/stitch-ash/server","watchOptions":{"ignored":[null]}}));
storage$1.mount('cache:nuxt:payload', _47home_47olive_47Repositories_47stitch_45ash_47node_modules_47_46pnpm_47_64nuxt_43nitro_45server_644_464_466__64babel_43plugin_45syntax_45typescript_647_4628_466__64babel_43core_647_4629_460__db0_98812eafb88dd10d4ca957f6d9b93d29_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/home/olive/Repositories/stitch-ash/node_modules/.pnpm/@nuxt+nitro-server@4.4.6_@babel+plugin-syntax-typescript@7.28.6_@babel+core@7.29.0__db0_98812eafb88dd10d4ca957f6d9b93d29/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/home/olive/Repositories/stitch-ash/.nuxt/cache/nuxt/payload"}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/olive/Repositories/stitch-ash/.nuxt"}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/olive/Repositories/stitch-ash/.nuxt/cache"}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/olive/Repositories/stitch-ash/.data/kv"}));
...
const _WuxlXegvfPoAx5pxCL710fpumZTpBTf0BFl5OAcoueU = (function(nitro) {
...
var cart = {
	...
	toast: {
		...
		view: "View cart",
		error: {
			init: "Could not initialize cart.",
			get: "Could not retrieve cart.",
			add: "Could not add item to cart.",
			update: "Could not update item in cart.",
			remove: "Could not remove item from cart.",
...
var home = {
	...
	description: "This is a demo store built with Nuxt 4 and the Shopify Storefront API. It showcases how to build a fully functional e-commerce storefront with Nuxt UI."
};
var seo = {
	description: "Welcome to our demo store! Explore our collections and find the perfect items for you. Enjoy a seamless shopping experience with Nuxt and Shopify."
};
var error = {
...
const locale_en_46json_b053c6eb = {
	footer: footer,
	cart: cart,
	search: search,
	account: account,
...
const localeLoaders = {
  "en-us": [
    {
      key: "locale_en_46json_b053c6eb",
      load: () => Promise.resolve(locale_en_46json_b053c6eb),
      cache: true
    }
  ]
};
...
const createStoreDomain = (name) => `https://${name}.myshopify.com`;
const createApiUrl = (storeDomain, apiVersion, apiPrefix) => joinURL(
  storeDomain,
...
const createStorefrontConfig = (config) => {
  ...
  const privateAccessToken = config?.clients?.storefront?.privateAccessToken;
...
const _3Lr2NqiyQpkUV1l9XtMwQLzDmRornO6nRYotrolsM = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const rootDir = "/home/olive/Repositories/stitch-ash";
...
const _kcwOWdHyg7dYrNZsRAdGt2vKoysUqvUuIYzqetDA7M = (nitroApp) => {
...
const plugins = [
  _WuxlXegvfPoAx5pxCL710fpumZTpBTf0BFl5OAcoueU,
_3Lr2NqiyQpkUV1l9XtMwQLzDmRornO6nRYotrolsM,
_kcwOWdHyg7dYrNZsRAdGt2vKoysUqvUuIYzqetDA7M,
...
const _4j6PDz = eventHandler((event) => {
...
const _JRxy2z = defineEventHandler(async (event) => {
  ...
  const cacheConfig = storefrontConfig?.cache ? storefrontConfig.cache : void 0;
  const cacheOption = headers["x-shopify-proxy-cache"] ?? "none";
  const requestCacheConfig = cacheConfig?.options ? cacheOption in cacheConfig.options ? cacheConfig.options[cacheOption] : void 0 : void 0;
  const cacheBase = typeof cacheConfig?.proxy === "string" ? cacheConfig.proxy : typeof cacheConfig?.proxy === "object" ? cacheConfig.proxy.base : void 0;
  const cachedProxyRequest = defineCachedFunction(async (url, method, headers2, body2) => {
    delete headers2["x-shopify-proxy-cache"];
    return await $fetch(url, { method, headers: headers2, body: body2 });
  }, {
    name: "storefront-proxy",
    shouldBypassCache: () => !requestCacheConfig,
    getKey: (_url, _method, _headers, body2) => hash$1(body2),
...
const createAdminConfig = (config) => {
...
const createCustomerAccountConfig = (config) => {
...
const withCustomerAccountCredentials = async (client, event) => {
...
let pendingAccessTokenRequest;
async function getTokenStorage(config) {
  const storageBase = typeof config.tokenStorage === "string" ? config.tokenStorage : "admin-token";
  return (await Promise.resolve().then(function () { return index; })).useStorage(storageBase);
}
function isTokenExpired(token) {
  if (!token.expiresAt) return false;
  return Date.now() >= token.expiresAt - 5 * 60 * 1e3;
}
async function fetchAccessToken(storeDomain, params) {
...
async function getAdminAccessToken(shopName, config, store) {
  ...
  let storedToken = store ? await getTokenStorage(config).then((storage) => storage.getItem("token")) : void 0;
  ...
  if (pendingAccessTokenRequest) {
    const token2 = await pendingAccessTokenRequest;
  ...
  pendingAccessTokenRequest = fetchAccessToken(
    ...
    pendingAccessTokenRequest = void 0;
  });
  const token = await pendingAccessTokenRequest;
  return token.accessToken;
}
const withAdminCredentials = async (client, config) => {
...
const _0yJV_h = defineEventHandler(async (event) => {
  const { _shopify } = useRuntimeConfig();
  const clientType = event.path.split("/").pop();
  ...
  switch (clientType) {
    ...
    case "customerAccount":
      ...
      return await withCustomerAccountCredentials(client, event).then((client2) => client2.request(body.query, { variables: body.variables }));
    case "admin":
      client = createClient(createAdminConfig(_shopify));
      return await withAdminCredentials(client, _shopify).then((client2) => client2.request(body.query, { variables: body.variables }));
    default:
...
const _DTdzGU = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _AC3OdM = _messagesHandler ;
...
const _lazy_5RqqJx = () => Promise.resolve().then(function () { return bugReport$1; });
const _lazy_MA1zAH = () => Promise.resolve().then(function () { return checkout$1; });
const _lazy_BuYrqM = () => Promise.resolve().then(function () { return renderer; });

const handlers = [
  { route: '', handler: _4j6PDz, lazy: false, middleware: true, method: undefined },
  { route: '/api/bug-report', handler: _lazy_5RqqJx, lazy: true, middleware: false, method: undefined },
  { route: '/api/checkout', handler: _lazy_MA1zAH, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_BuYrqM, lazy: true, middleware: false, method: undefined },
  { route: '/_proxy/storefront', handler: _JRxy2z, lazy: false, middleware: false, method: undefined },
  { route: '/_sandbox/proxy/storefront', handler: _0yJV_h, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _DTdzGU, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _AC3OdM, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: handler$1, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_BuYrqM, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BuYrqM, lazy: true, middleware: false, method: undefined }
];
...
const asString$1 = (value) => typeof value === "string" ? value.trim() : "";
const sanitizeSeverity = (severity) => {
  const value = asString$1(severity);
...
async function createPaperclipIssue(payload, env) {
  ...
  const titleRoute = asString$1(payload.route) || "unknown route";
  ...
  const description = [
    ...
    `Route: ${titleRoute}`,
    `Severity: ${severity}`,
    `Contact: ${asString$1(payload.email) || "not provided"}`,
    "",
    "Report:",
    asString$1(payload.description),
    "",
    "Diagnostics:",
    "```json",
...
async function storeHumanAdminReport(payload, env) {
  ...
  const report = {
    ...
    description: asString$1(payload.description),
    email: asString$1(payload.email),
    route: asString$1(payload.route),
...
const bugReport = defineEventHandler(async (event) => {
  ...
  const description = asString$1(payload == null ? void 0 : payload.description);
...
const bugReport$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: bugReport
}, Symbol.toStringTag, { value: 'Module' }));
